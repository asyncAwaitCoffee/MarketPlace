...
AS BEGIN
	...
	WHERE ID = @ITEM_ID
		...
		SELECT 1 FROM MARKET_PLACE.MARKET_PERSONS AS P
		WHERE P.MARKET_USER_ID = @USER_ID AND P.BALANCE >= I.CURRENT_PRICE + I.BID_STEP)
	...
	BEGIN
		...
		WHERE MARKET_USER_ID = @PREVIOUS_BIDDER
