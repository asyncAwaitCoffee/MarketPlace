...
DROP TABLE IF EXISTS MARKET_PLACE.ITEMS_FAVORITE
CREATE TABLE MARKET_PLACE.ITEMS_FAVORITE
(	
	MARKET_USER_ID INT,
	MARKET_ITEM_ID INT,
)

CREATE CLUSTERED INDEX ITEMS_FAVORITE_CI ON MARKET_PLACE.ITEMS_FAVORITE
(
	MARKET_USER_ID,
	MARKET_ITEM_ID
)
